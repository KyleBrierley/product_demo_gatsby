...
const Hit2 = (props) => (
    <Layout>
        <Helmet>
            <title>Hit 2 Page</title>
            <meta name="description" content="Hit 2 Page" />
        </Helmet>
        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    <header className="major">
                        <h1>Publisher Site 2</h1>
                    </header>
                    <span className="image main"><img src={pic11} alt="" /></span>
                    <p>User browses to this second publisher site where ads are being served via publisher ad server</p>
            ...
            <img src="https://qa20-databridge.tiqcloud.com/databridge/thx11381/tdb.gif?test=true&total_impressions=_INC_1&last_campaign_seen=spider-man&adv_campaign_eid=_APP_$ecid"></img>
        </div>
